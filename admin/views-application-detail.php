...
$sql= "update tblapplicat set Status=:status,Remark=:remark where ID=:vid";
...
$sql="SELECT tblapplicat.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tblapplicat join  tbluser on tblapplicat.UserID=tbluser.ID where tblapplicat.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
