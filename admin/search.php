...
<head>
    ...
    <title>Birth Search | Online Birth/Death Certificate Management System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Search Birth Application</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Search <span class="table-project-n"></span> Birth Application</h1>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Search by Birth Application Number</label>
                                                                </div>
                                                                <div class="col-lg-9">
