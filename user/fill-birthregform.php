...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
$sd="insert into tbllog(UserID,ApplicationID,FullName)values(:uid,:appnumber,'Birth Record')";
$log=$dbh->prepare($sd);
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                <input type="date" class="form-control" name="dob" value="<?php echo date("Y-m-d");?>" max="<?php echo date("Y-m-d");?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
