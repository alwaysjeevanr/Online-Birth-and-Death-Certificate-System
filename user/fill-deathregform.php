...
$MIN = 100000000;
$MAX = 999999999;
$appnumber=mt_rand($MIN,$MAX);
$ret="select DateofBirth from tblapplicat where DateofBirth=:dod || NameofFather=:fname";
...
$sql="insert into tblapplicat(UserID,ApplicationID,DateofBirth,Gender,FullName,PlaceofBirth,NameofFather,PermanentAdd)values(:uid,:appnumber,:dod,:gender,:fname,:pod,:fathername,:padd)";
...
$query->bindParam(':padd',$padd,PDO::PARAM_STR);
 $query->execute();
 $sd="insert into tbllog(UserID,ApplicationID,FullName)values(:uid,:appnumber,'Death Record')";
 $log=$dbh->prepare($sd);
 $log->bindParam(':uid',$uid,PDO::PARAM_STR);
 $log->bindParam(':appnumber',$appnumber,PDO::PARAM_STR);
  $log->execute();
...
echo "<script>alert('Date of Death and Father Name is  already exist. Please try again');</script>";
...
<head>
    ...
    <title>Death Certificate Form | Online Birth/Death Certificate Management System</title>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                <input type="date" class="form-control" name="dod" value="<?php echo date("Y-m-d");?>" max="<?php echo date("Y-m-d");?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" required="true" value="" name="pod" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Full Name of Father/Husband</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Address of Deceased time of Death</label>
                                                                </div>
                                                                <div class="col-lg-9">
